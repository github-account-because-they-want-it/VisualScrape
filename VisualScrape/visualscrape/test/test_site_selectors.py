...
autotrader_item_selector = autotrader_item_selector = ItemSelector([
                               KeyValueSelector("Model", FieldSelector("h1.listing-title::text", FieldSelector.CSS)),
                               KeyValueSelector("Price", FieldSelector("h4.primary-price span::text", FieldSelector.CSS)),
                               KeyValueSelector("Mileage", FieldSelector("span.atcui-clear heading-mileage", FieldSelector.CSS)),
                               KeyValueSelector("Exterior Color", 
                                                FieldSelector("div.atcui-column.atcui-span-6.overview-infobar-subsection span.colorName:nth-child(1)::text", FieldSelector.CSS)),
                               KeyValueSelector("Interior Color", 
                                                FieldSelector("div.atcui-column.atcui-span-6.overview-infobar-subsection span.colorName:nth-child(2)::text", FieldSelector.CSS)),
                               KeyValueSelector("Fuel Type", FieldSelector("div.mpg-section h2::text", FieldSelector.CSS)),
                               KeyValueSelector("Engine", 
                                                FieldSelector("div.atcui-column.atcui-span-5.overview-infobar-subsection:nth-of-type(3) h2::text", FieldSelector.CSS)),
                               KeyValueSelector("Transmission", 
                                                FieldSelector("div.atcui-column.atcui-span-5.overview-infobar-subsection:nth-of-type(3) div.atcui-clearfix:nth-child(2) span.atcui-bold::text", FieldSelector.CSS)),
                               KeyValueSelector("Drive Type", 
